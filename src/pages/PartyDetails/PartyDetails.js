      ...
      <div>
        ...
        <div className="gallery">
          <img
            ...
            width="564"
            height="376"
            src={images[0] ? images[0]: "https://faro.travel/blog/wp-content/uploads/2017/05/Fiesta.jpg"}
            alt=""
          />
          <img
            className="images"
            width="274"
            height="183"
            src={images[1] ? images[1]: "https://micasainn.com/wp-content/uploads/2016/06/IBIZA.jpg"}
            alt=""
          />
          <img
            className="images"
            width="274"
            height="183"
            src={images[2] ? images[2]: "https://assets.entrepreneur.com/content/3x2/2000/1594842136-Depositphotos-55474203-l-2015.jpg?width=700&crop=2:1"}
            alt=""
          />
          <img
            className="images"
            width="274"
            height="183"
            src={images[3] ? images[3]: "https://revistahsm.com/wp-content/uploads/2018/08/Fiestas.png"}
            alt=""
          />
          <img
            className="images"
            width="274"
            height="183"
            src={images[4] ? images[4]: "https://i.blogs.es/db2df3/fiestas-covid-en-mexico/1366_2000.jpg"}
            alt=""
          />
        </div>
        ...
        <div className="section2">
          ...
          <p>{ateendees.length} of {maxAttendees}</p>
          </div>
          </div>
          <hr></hr>
          </div>
          <div className="jointhisparty">
            ...
            <Link to={`/stripe/${this.props.match.params.id}`}><Button onClick={()=> this.joinparty(this.props.match.params.id, this.props.user.id)}  id="joinpartybutton" variant="contained" color="secondary">
            Join this Party
            </Button></Link>
